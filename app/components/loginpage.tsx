...
const LoginPage: FC = () => {
    ...
    const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
        event.preventDefault(); // Zabráníme defaultnímu chování formuláře
        
        // Zkontrolujeme, zda jsou pole vyplněná
        if (!email || !password) {
            alert("Please fill in all fields."); // Zobrazí varování
            return; // Pokud není vše vyplněné, neprovádí se žádné další akce
        }
